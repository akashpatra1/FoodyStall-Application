        ...
        Box (modifier = Modifier.fillMaxSize()){
            ...
            Row(
                modifier = Modifier.fillMaxWidth()
                    .padding(top = 10.dp, end = 12.dp, start = 12.dp),
          ...
          pageCount(pagerState = pager)
            Column(
                modifier = Modifier.fillMaxWidth().padding(top = 192.2.dp).height(120.dp)
            ) {
                SmallDetailCard()
                DetailCard()
            }
...
fun CardImageRow(
    ...
    HorizontalPager(
        ...
        when(pagerState.currentPage){
            0 -> AsyncImage (model= R.drawable.vegbiryani,
                modifier = Modifier.fillMaxWidth(),
...
fun DetailCard() {
    ...
    Card(
        ...
        Column(modifier = Modifier.fillMaxSize()) {
            ...
            // First Row: Restaurant name & rating
            Row(
                modifier = Modifier
                    .fillMaxWidth()
            ...
            // Second Row: "On time preparation"
            Card(
                modifier = Modifier
...
@Composable
fun SmallDetailCard() {
    val timedText = remember { mutableStateOf("44 min") }
