...
fun TopAppBarDeliveryScreen(scrollBehavior:TopAppBarScrollBehavior,navController: NavController){
    TopAppBar(
        title = {
            Column {
                Row(modifier = Modifier.fillMaxWidth().height(22.dp)) {
                    ...
                    Icon(painter = painterResource(com.example.foodystall.R.drawable.down_arrow),
        ...
        navigationIcon = {
            Icon(painter = painterResource(com.example.foodystall.R.drawable.locationdeliveryscreen),
